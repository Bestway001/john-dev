...
import Ahuse from "../assets/images/image.png";
import App from "../assets/images/imagee.png";
import easy from "../assets/images/images1.png";
    ...
    <div className="mx-6 md:body mt-8 md:mt-12 ">
      <div className="flex md:flex justify-between">
        <div className="home1">
          ...
          <h3 className="font-bold text-2xl md:font-bold md:text-6xl">My Portfolio</h3>
        </div>
        <div>
      ...
      <div className=" md:flex md:gap-16 mt-12">
        <div className="">
          ...
          <a className="font-semibold underline	decoration-hover flex mb-3" href="#">
            View website
